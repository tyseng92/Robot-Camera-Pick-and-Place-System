...
path = os.path.join(os.environ["HOME"],"Desktop/image_database/yolo/PHASE_2/cam2/image/muffin/data_rot")
...
def convert(ulist, angle):
    ...
    if angle == 90:
        ...
        swap = {'9':'9','10':'10','11':'13','12':'14','13':'15','14':'16','15':'17','16':'18','17':'11','18':'12'}
        cls = swap[ulist[0]] 
        ...
        swap = {'9':'9','10':'10','11':'15','12':'16','13':'17','14':'18','15':'11','16':'12','17':'13','18':'14'}
        cls = swap[ulist[0]]
        ...
        swap = {'9':'9','10':'10','11':'17','12':'18','13':'11','14':'12','15':'13','16':'14','17':'15','18':'16'}  
        cls = swap[ulist[0]] 
        return [cls, str(x), str(y), ulist[4] , ulist[3]]
